...
const AdminCareersPage = () => {
  ...
  const fetchJobs = async () => {
    try {
      const response = await fetch(buildApiUrl('/admin/careers'));
      const data = await response.json();
      
      // Debug log to see the response format
  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch(buildApiUrl('/admin/job-applications'));
      const data = await response.json();
  ...
  const handleDeleteJob = async (jobId) => {
    ...
    try {
      const response = await fetch(buildApiUrl(`/admin/careers/${jobId}`), {
        method: 'DELETE'
      });
  ...
  const handleStatusChange = async (jobId, newStatus) => {
    try {
      const response = await fetch(buildApiUrl(`/admin/careers/${jobId}/status`), {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleApplicationStatusChange = async (applicationId, newStatus) => {
    try {
      const response = await fetch(buildApiUrl(`/admin/job-applications/${applicationId}/status`), {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const downloadResume = (application) => {
    ...
    window.open(buildApiUrl(`/admin/job-applications/${application.id}/resume`), '_blank');
  };
